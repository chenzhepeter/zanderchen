...
export const SHIPS = [
  {
    ...
    hull: 70, armor: 1, speed: 7.5, guns: 2, cargo: 90, crewMax: 20, price: 900,
    note: '近海跑腿的小船。火力可怜，但吃水浅、进得了浅滩，货舱够装一趟远航的口粮。',
  },
  {
    id: 'sloop', name: '单桅纵帆船', nameEn: 'Sloop', cls: 'light',
    hull: 110, armor: 2, speed: 9.5, guns: 8, cargo: 120, crewMax: 45, price: 3200,
    note: '海盗最爱的船型：快、灵活、能贴着沙洲跑，军舰追不上。',
  },
  {
    id: 'schooner', name: '双桅纵帆船', nameEn: 'Schooner', cls: 'light',
    hull: 140, armor: 2, speed: 10.5, guns: 10, cargo: 150, crewMax: 65, price: 5400,
    note: '抢风性能极佳，逆风时比横帆船占尽便宜。',
  },
  {
    id: 'brigantine', name: '双桅横帆船', nameEn: 'Brigantine', cls: 'medium',
    hull: 195, armor: 3, speed: 8.5, guns: 14, cargo: 200, crewMax: 95, price: 8600,
    note: '攻守兼备的中型船，海盗把它当主力舰用。',
  },
  {
    id: 'fluyt', name: '弗鲁特商船', nameEn: 'Fluyt', cls: 'trade',
    hull: 210, armor: 2, speed: 6.5, guns: 8, cargo: 340, crewMax: 60, price: 9800,
    note: '荷兰人的运货机器：肚子大、水手少、跑得慢——海盗眼里的肥羊。',
  },
  {
    id: 'frigate', name: '巡防舰', nameEn: 'Frigate', cls: 'war',
    hull: 310, armor: 5, speed: 8.0, guns: 28, cargo: 210, crewMax: 170, price: 21000,
    note: '皇家海军的多面手，火力与航速兼顾。',
  },
  {
    id: 'galleon', name: '大帆船', nameEn: 'Galleon', cls: 'trade',
    hull: 390, armor: 5, speed: 5.5, guns: 30, cargo: 380, crewMax: 190, price: 27000,
    note: '西班牙珍宝船队的主力。又大又慢，但一舷炮打过来能把小船掀翻。',
  },
  {
    id: 'manowar', name: '战列舰', nameEn: 'Man-o-War', cls: 'war',
    hull: 540, armor: 7, speed: 5.0, guns: 52, cargo: 280, crewMax: 340, price: 46000,
    note: '海上的移动堡垒。见到它升起战旗，聪明人就该转舵逃跑。',
  },
  {
    id: 'qar', name: '安妮女王复仇号', nameEn: "Queen Anne's Revenge", cls: 'war',
    hull: 430, armor: 6, speed: 8.0, guns: 40, cargo: 320, crewMax: 260, price: 0, story: true,
