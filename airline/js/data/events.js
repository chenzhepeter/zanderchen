...
export const EVENTS = [
  ...
  {
    id: 'ev_na_wc',
    triggerYear: 2026, triggerQuarter: 2,
    nameZh: '北美三国世界杯',
    descZh: '美墨加三国合办世界杯，跨境旅客创纪录。',
    effects: [
      { kind: 'demand', scope: 'region:namerica', mult: 1.30, durationQuarters: 1 },
    ],
  },
  ...
  // ============== 2027 ==============
  {
    ...
    choice: {
      prompt: '是否申请"绿色舰队认证"？',
      options: [
        { label: '申请（一次性 8 亿，永久 +1 声望/季）', costCash: 800, applyEffects: [{ kind: 'prestigePerQuarter', delta: 1 }] },
  ...
  {
    id: 'ev_la_olympics',
    triggerYear: 2028, triggerQuarter: 3,
    nameZh: '洛杉矶奥运会',
    descZh: 'LAX 客流暴增，加州航线全线吃紧。',
    effects: [
      { kind: 'demand', scope: 'country:US', mult: 1.25, durationQuarters: 1 },
    ],
  },
  ...
  {
    id: 'ev_climate_tax',
    triggerYear: 2029, triggerQuarter: 3,
    nameZh: '全球碳税立法',
    descZh: 'G20 通过统一碳定价，长程航线成本明显上升。',
    effects: [
